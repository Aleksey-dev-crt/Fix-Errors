...
const navigationDropDownMain = document.querySelector(".navigation__item_show-dropdown");
const navigationDropDownFromMenu = document.querySelector(".navigation__item_vertical");
...
const toggleMenu = () => {
  ...
  header.classList.toggle("mobile-header_hidden");
}
...
const openDropDownMenu = (buttonArea) => {
  const dropdownMenuNews = buttonArea.parentElement.querySelector(".navigation__dropdown-menu");
  const menuItemArrow = buttonArea.parentElement.querySelector(".navigation__button_arrow");
...
document.addEventListener("click", event => {
  const buttonToNewsMain = event.target.classList.contains("navigation__item_show-dropdown");
  const buttonToNewsFromMenu = event.target.classList.contains("navigation__item_vertical_show-dropdown");

  if (buttonToNewsMain) openDropDownMenu(navigationDropDownMain);
  if (buttonToNewsFromMenu) openDropDownMenu(navigationDropDownFromMenu);
});
